...
const radius = image_size.value.width / 38;
const stroke_width = image_size.value.width / 121;
</script>
                ...
                <div>
                    ...
                    <div v-if="preview">
                        <svg width="100%" :viewBox="'0 0 ' + image_size.width + ' ' + image_size.height"
                            ...
                            <circle :cx="a.cx" :cy="a.cy" :r="radius" :stroke-width="stroke_width" stroke="#fff"
