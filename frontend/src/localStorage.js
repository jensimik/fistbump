...
export const filter_sections = useLocalStorage("filter_sections", ["S1", "S2", "S3", "S4", "S5", "Ö", "L"]);
...
export const filter_rp_sections = useLocalStorage("filter_rp_sections", ["B", "Ö", "L"]);
export const filter_rp_grades = useLocalStorage("filter_rp_grades", ["green", "yellow", "blue", "purple", "red", "brown", "black"]);
